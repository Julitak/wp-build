...
function theme_scripts(){
    ...
    if ( !is_admin() ) {
        ...
        wp_deregister_script('jquery');
				wp_register_script('jquery', ASSETS_URL . '/assets/scripts/jquery-3.2.0.min.js', false, '3.2.0', true);
				wp_register_script('bootstrap', ASSETS_URL . '/assets/scripts/bootstrap.min.js', false, '1', true);

        wp_register_script('js_main', ASSETS_URL . '/assets/scripts/yo.js', array('jquery', 'bootstrap'), '1.0', true);
...
function theme_stylesheets(){
	...
	$styles_path = ASSETS_URL . '/assets/css/finalsection.css';

	if( $styles_path ) {
		wp_register_style('reset', ASSETS_URL . '/assets/css/css-reset.css', array(), false, 'all');
		wp_register_style('bootstrap', ASSETS_URL . '/assets/css/bootstrap.min.css', array(), false, 'all');
		wp_register_style('bootstrap-themes', ASSETS_URL . '/assets/css/bootstrap-theme.min.css', array(), false, 'all');


		wp_register_style('main-css', ASSETS_URL . '/assets/css/section-menus.css', array('reset', 'bootstrap', 'bootstrap-themes'), false, 'all');
...
function register_theme_menus() {
	...
	register_nav_menus(array( 
        ...
        'tech-navigation' => __( 'Tech' ),
        'entertainment-navigation' => __( 'Entertainment' ),
        'business-navigation' => __( 'Business' ),
        'lifestyle-navigation' => __( 'Lifestyle' ),
        'media_list-navigation' => __( 'Media List' )
...
function awesome_menu($menu, $classes) { 
	wp_nav_menu(array(
